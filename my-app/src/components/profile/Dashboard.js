...
export const Dashboard = () => {
    ...
    useEffect(() => {
        if (user) {
            axios.post('/profile/dashboard', { email: user.email })
                .then(res => {
                ...
                <div className="row innerrow bg-white shadow rounded overflow-hidden">
                    <div className="px-4 pt-0 pb-4 cover">
                        <div className="media align-items-end profile-head">
                            <div className="profile mr-3">
                                ...
                                <a href="/volunteerform" className="btn btn-outline-dark btn-sm btn-block edits" onClick={() => {
                                    history.push('/profile/VolunteerForm')
                                }}>Edit profile</a>
                            </div>
                            <div className="media-body mb-5 text-white text-white-prof">
                                <h3>{obj ? obj.username : null}</h3>
                    ...
                    <div class="bg-light p-4 d-flex justify-content-center text-center">
                        <ul class="list-inline mb-0">
                            ...
                            <li class="list-inline-item">
                                <h5 class="font-weight-bold mb-0 d-block">{
                                    obj ? obj.eventsCount : 0
                                }</h5><small class="text-muted"> <i class="fas fa-user mr-1"></i>Activities</small>
                            </li>
                            <li class="list-inline-item">
                                <h5 class="font-weight-bold mb-0 d-block">{
                                    obj ? obj.minutes : 0
                                }</h5><small class="text-muted"> <i class="fas fa-clock mr-1"></i>Hours</small>
                            </li>
                        </ul>
                    </div>
                    <div className="px-4 py-3">
                        ...
                        <div className="p-4 rounded shadow-sm bg-light regeve">
                            <ul className="nobull">
                                {
                                    obj ? obj.pendingEvents.map((event) => {
                                        return <DashboardHelper props={event}/>
                        ...
                        <div className="row">
                            <div className="card mb-3 col-md-6">
                                ...
                                <div className="card-body">
                                    <h5 className="card-title">{obj ? obj.username : null}</h5>
                            ...
                            <div className="card mb-3 col-md-6 offset-2">
                                ...
                                <div className="card-body">
                                    <h5 className="card-title">{obj ? obj.username : "No username"}</h5>
                                    <p className="card-text">Partcipation details</p>
                                    <p className="card-text"><b>Number of hours</b> : 8</p>
                                    <p className="card-text">
                                        <small>
                                            <i class="fas fa-heart hert"><span> 2</span></i>
                                            <i class="far fa-comment cmt"><span> 10</span></i>
                                        </small>
                                    </p>
                                </div>
                            </div>
